...
const ProjectCard = ({ img, title, techstack, paragraph }) => {
  return (
    <>
      <div className="projectcard bg-[#D3F4FF] rounded-2xl border-[2px] border-[#106396] flex flex-col mb-4 text-[#106396] md:w-2/5">
